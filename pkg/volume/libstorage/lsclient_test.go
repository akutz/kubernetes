...
func tstSetupExec(t *testing.T) {
	...
	if err := os.Mkdir(lsxPath, 0755); err != nil {
		t.Fatal(err)
	}
...
func tstClearExec(t *testing.T) {
	if err := os.RemoveAll(lsxPath); err != nil {
